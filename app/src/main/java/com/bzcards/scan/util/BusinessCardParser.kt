...
object BusinessCardParser {
    ...
    // Matches labeled phone entries like "CO: (555)..." or "C: (555)..." even when jammed together
     ...
     * Handles split names ("JANE" + "DOE"), companies ("Acme" + "SOFTWARE"),
    ...
    private fun extractAllPhones(lines: List<String>, rawText: String): List<String> {
        ...
        // This handles cases like "CO: (555) 123-4567C: (555) 987-6543"
    ...
    private fun extractCompany(
        ...
        // e.g., jdoe@acmecorp.com → "acmecorp"
        if (email.isNotBlank()) {
    ...
    private fun extractName(
        ...
        // These are lines that look distinctly like person names (e.g., "JANE DOE")
        for (i in lines.indices) {
            val line = lines[i]
            val tags = lineTags[i]
        ...
        // e.g., jdoe@... or jane.doe@... → look for matching line
